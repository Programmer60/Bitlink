    ...
    return (
      <div className="h-190 flex flex-col bg-purple-50 text-gray-800">
        <main className="flex-1 max-w-3xl mx-auto px-6 py-16">
          ...
          <p className="mb-4 text-lg">
            Whether you're a developer or just someone who wants to simplify links, Bitlink provides a clean and user-friendly interface
            to generate, manage, and access short URLs.
          </p>
          <p className="text-lg">
